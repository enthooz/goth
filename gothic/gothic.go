...
See https://github.com/enthooz/goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/enthooz/goth/examples/main.go to see this in action.
*/
